# -*- coding: utf-8 -*-
"""
Created on Mon Jun 17 16:31:29 2024
...
portifolio_onshore = "1004"  # TODO remover
data_ini_onshore = "09112023"
portifolio_offshore = "2004"  # TODO remover
data_ini_offshore = "19102023"
client_name="GUILHERME PINHO BONIFÁCIO" #TODO remover
...
perf_attr_fill(final_onshore["df_final_AlocacaoClasse"]["Classe"].to_list(), final_onshore["df_final_PerfAttr"].copy(), slide)
...
perf_attr_fill(final_offshore["df_final_AlocacaoClasse"]["Classe"].to_list(), final_offshore["df_final_PerfAttr"].copy(), slide)
...
prs.save(f"TESTE2/{client_name}_{meses[data_fim.month]}2024.pptx")
print(client_name)